...
Supported components: Spinner, ContentSpinner, Timer, SpanTimer, CountdownTimer.
Future components: Modal, ToggleSwitch.
...
```  
PM > Install-Package D20Tek.BlazorComponents.Spinner -Version 1.0.12
PM > Install-Package D20Tek.BlazorComponents.Timer -Version 1.0.12
``` 
